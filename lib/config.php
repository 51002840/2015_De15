...
class Config {
	...
	public static $absolutePath = '/pictureg15/';
	public static $frontendPath = 'http://leong.vn/pictureg15';
	public static $siteName = 'SlideShow and Picture G15';
	public static $siteTitle = 'SlideShow and Picture G15';
